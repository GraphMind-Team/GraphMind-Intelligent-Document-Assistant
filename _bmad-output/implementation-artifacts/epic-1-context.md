...
- Design tokens (light / dark) are the single source of truth for color — no component hardcodes a raw hex value. Four token gaps are explicitly assigned to this epic to close before component work begins elsewhere:
