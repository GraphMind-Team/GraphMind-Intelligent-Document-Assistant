"""Knowledge graph module business logic (Story 4.1).
...
def get_graph(current_user: User) -> GraphResponse:
    ...
    entity_rows, relationship_rows, total_node_count = get_graph_for_user(str(current_user.id))
