...
def test_run_question_treats_a_503_as_a_run_error_not_a_refusal():
    ...
    def _raising_ask_fn(db, user, question_text, document_ids, *, use_history=True, use_router=True):
...
def test_run_question_scores_a_correct_answerable_response_end_to_end():
    ...
    def _fake_ask(db, user, question_text, document_ids, *, use_history=True, use_router=True):
...
def test_run_question_asks_with_history_and_routing_disabled():
    ...
    def _capturing_ask_fn(db, user, question_text, document_ids, *, use_history=True, use_router=True):
